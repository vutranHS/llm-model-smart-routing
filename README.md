...
- **ONNX weights** `query-classifier/model_fp16.onnx` (~150MB) — **không** nằm trong git (GitHub 100MB/file limit)

```bash
./fetch_classifier.sh    # copy từ MiMo Desktop hoặc CLASSIFIER_URL
